...
public class Assignment5 {
    ...
    // the compressionAlgoList of algorithms in the dropdown box. if you wanted to add another,
    // you would include it here and add another case in the onAlgorithmRun
    // method.
    private static final String[] COMPRESSION_ALGORITHMS = {"Huffman coding", "Lempel Ziv" };
    private static final String[] SEARCH_ALGORITHMS = {"KMP", "Brute Force" };
    ...
    private JComboBox<String> compressionAlgoList;
    private JComboBox<String> searchAlgoList;
    ...
    private void onAlgorithmRun() {
        try {
            ...
            String algorithm = (String) compressionAlgoList.getSelectedItem();
...
//            System.out.println("Searching for: " + pattern);
            int index;
            if (searchAlgoList.getSelectedItem().equals(SEARCH_ALGORITHMS[0])) {
//                long start = System.currentTimeMillis();
                index = new KMPSearch(pattern, text).search(pattern, text);
//                long timeMillis = System.currentTimeMillis()-start;
//                System.out.println("KMP search took: " + timeMillis + "ms");
            } else {
//                start = System.currentTimeMillis();
                index = BruteForceSearch.search(pattern, text);
//                timeMillis = System.currentTimeMillis()-start;
//                System.out.println("Brute force search took: " + timeMillis + "ms");
            }
        ...
        searchAlgoList = new JComboBox<>(SEARCH_ALGORITHMS);
        searchAlgoList.setMaximumSize(searchAlgoList.getPreferredSize());
        ...
        compressionAlgoList = new JComboBox<>(COMPRESSION_ALGORITHMS);
        compressionAlgoList.setMaximumSize(compressionAlgoList.getPreferredSize());
        ...
        leftTop.add(compressionAlgoList, BorderLayout.SOUTH);

        // a go button.
        JButton run = new JButton("Run");
        run.addActionListener(ev -> onAlgorithmRun());
